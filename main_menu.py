...
class SearchWindow:
    ...
    def open_search_window(self, image, previous_window, chest_location, found_item_location):  # Create Chest Window
        while True:
            ...
            button_maker(100, 550, 150, 40, 'pure_red', 'pure_red', '', 30, 'STAMINA = ' + str(player1.stamina),
                         'white',  # Stamina
                         transparent_on=True)
            button_maker(250, 550, 150, 40, 'pure_red', 'pure_red', '', 30, 'HEALTH = ' + str(player1.health), 'white',
                         # Health
                         transparent_on=True)
            button_maker(400, 550, 150, 40, 'pure_red', 'pure_red', '', 30, 'FOOD = ' + str(player1.food), 'white',
                         # Food
                         transparent_on=True)
            button_maker(550, 550, 150, 40, 'pure_red', 'pure_red', '', 30, 'DRINK = ' + str(player1.drink), 'white',
                         # Drink
                         transparent_on=True)
